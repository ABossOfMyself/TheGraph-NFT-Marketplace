...
export class NFTCancelled extends ethereum.Event {
  get params(): NFTCancelled__Params {
    return new NFTCancelled__Params(this);
  }
}

export class NFTCancelled__Params {
  _event: NFTCancelled;

  constructor(event: NFTCancelled) {
    this._event = event;
  }
